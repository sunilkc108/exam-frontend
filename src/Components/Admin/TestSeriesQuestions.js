...
export const TestSeriesQuestions = () => {
  ...
  const deleteQuestion = (i, id) => {
    ...
    Axios.delete(`http://localhost:5055/admin/delete-series-question/${id}`, {
      headers: {
                ...
                <div className="ibox">
                  <div className="ibox-content">
                    <div className="row justify-content-between">
                      <h2 className="card-title"> Test Series Questions</h2>
                      <Link
                        to={`/admin/series-questions-add/${seriesId}`}
                                ...
                                <tr key={i}>
                                  ...
                                  <td>
                                    <Link
                                      ...
                                      to={`/admin/series-questions/${seriesId}/${c._id}`}
                                    >
                                      Edit
                                    </Link>
                                    <button
